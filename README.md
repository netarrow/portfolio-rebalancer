...
- Each category points at an **asset** (its money becomes shares), at a **whole portfolio** (see below), or at a **broker's cash** (it stays liquid there). An asset mapping can also name the **broker** the order goes through and the **portfolio** it belongs to.
